    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
          ...
          <p className="text-surface-500 font-bold uppercase tracking-widest text-[10px]">Préparation du formulaire...</p>
        </div>
      </Layout>
    );
  }
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          >
            ...
            <p className="text-surface-500 mt-2 font-bold uppercase tracking-widest text-[10px] ml-20">
              Soumettez votre demande de permutation
            </p>
          </motion.div>
          
          <div className="flex items-center gap-3 bg-white p-2 rounded-2xl border border-surface-100 shadow-soft self-end md:self-auto">
        ...
        <AnimatePresence>
          {success && (
            <motion.div 
              ...
              className="p-6 bg-primary-50 border border-primary-100 rounded-3xl flex items-start gap-5 shadow-soft"
            >
          ...
          {error && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95 }}
              className="p-6 bg-red-50 border border-red-100 rounded-3xl flex items-start gap-5 shadow-soft"
            >
        ...
        {step === 1 ? (
          ...
          >
            <Card className="p-10">
              <form onSubmit={handleNext} className="space-y-12">
                {/* Infos Actuelles */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 bg-surface-50 rounded-3xl border border-surface-100 relative overflow-hidden group">
                  ...
                  <div className="space-y-2 relative z-10">
                    ...
                    <p className="text-surface-900 font-black text-xl tracking-tight">{employe?.etablissement?.nom || "—"}</p>
                  </div>
                  <div className="space-y-2 relative z-10">
                    <p className="text-[10px] font-black text-surface-400 uppercase tracking-[0.2em]">Région Administrative</p>
                    <p className="text-surface-900 font-black text-xl tracking-tight">{employe?.region?.libelle || "—"}</p>
                  </div>
                </div>

                <div className="space-y-10">
                  <div className="flex items-center gap-3 border-b border-surface-50 pb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="space-y-3">
                      ...
                      <select
                        ...
                        className="input-field py-4 cursor-pointer appearance-none font-bold"
                      >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="input-field py-4 cursor-pointer appearance-none font-bold disabled:bg-surface-50"
                        >
                  ...
                  <div className="space-y-8">
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows="4"
                        className="input-field py-5 min-h-[120px] resize-none font-bold"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        ...
                        <label
                          ...
                          className={`flex items-center justify-between px-8 py-6 bg-surface-50 border-2 border-dashed rounded-[2rem] cursor-pointer transition-standard group ${
                            formData.document ? 'border-primary-500 bg-primary-50/20' : 'border-surface-200 hover:border-primary-300 hover:bg-primary-50/10'
                          }`}
                        >
                          <div className="flex items-center gap-5">
                            <div className={`p-3.5 rounded-2xl transition-standard ${formData.document ? 'bg-primary-500 text-white shadow-primary' : 'bg-white text-surface-400 shadow-soft group-hover:text-primary-500'}`}>
                ...
                <div className="pt-10 border-t border-surface-50 flex justify-end">
                  <Button 
                    type="submit" 
                    variant="primary" 
                    size="lg"
          ...
          >
            <Card className="p-10 relative overflow-hidden group">
              ...
              <h2 className="text-xl font-black text-surface-900 mb-12 tracking-tight flex items-center gap-4 border-b border-surface-50 pb-6 relative z-10">
                <div className="p-2 bg-primary-500 text-white rounded-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                <div className="space-y-10">
                  <div className="flex items-center gap-8">
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="bg-surface-50 p-5 rounded-2xl border border-surface-100">
                        <p className="text-surface-900 font-black text-sm">{employe?.etablissement?.nom}</p>
                        <p className="text-primary-600 text-[10px] mt-1 font-black uppercase tracking-widest">{employe?.region?.libelle}</p>
                      </div>
                    </div>
                    <div className="shrink-0 w-12 h-12 bg-primary-500 rounded-2xl flex items-center justify-center text-white shadow-primary">
                      <ArrowRightIcon className="h-6 w-6" />
                    </div>
                    <div className="flex-1 space-y-3">
                      <p className="text-[10px] font-black text-surface-400 uppercase tracking-[0.2em]">Vers</p>
                      <div className="bg-primary-50/30 p-5 rounded-2xl border border-primary-100 shadow-soft">
                  ...
                  <div className="space-y-4">
                    ...
                    {formData.document ? (
                      <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-surface-100 shadow-soft">
                      ...
                      <div className="p-5 bg-surface-50 rounded-2xl border border-dashed border-surface-200 text-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-surface-50 p-8 rounded-[2rem] border border-surface-100 h-full">
